...
class Character {
 ...
 public:
 	Character(CharacterType type, const string &name, double health, double stamina, double attackDamage);
 	CharacterType getType() const;
 	const string & getName() const;
	//Returns the whole number of the health value (static_cast to int)
 	int getHealth() const;
    //Returns the whole number of the stamina value (static_cast to int)
